...
<section class="w-full">
    <div class="mb-6">
        <flux:heading size="xl">{{ __('Attendance Management') }}</flux:heading>
        <flux:subheading>{{ __('View and record attendance for any section') }}</flux:subheading>
    </div>
                ...
                <flux:table.row :key="$section->id">
                    ...
                    <flux:table.cell>
                        <div class="flex justify-end">
                            <flux:button size="sm" :href="route('admin.attendance.record', $section)" wire:navigate>
                                {{ __('Record') }}
                            </flux:button>
                        </div>
                    </flux:table.cell>

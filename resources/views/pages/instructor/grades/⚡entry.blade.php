...
new #[Title('Grade Entry')] class extends Component {
...
<section class="w-full">
    <div class="mb-6">
        <flux:heading size="xl">{{ __('Grade Entry') }}</flux:heading>
        <flux:subheading>
    ...
    @if (! $selected)
        <flux:callout>
            ...
            <flux:callout.text>{{ __('Select an assessment above to enter grades.') }}</flux:callout.text>
        </flux:callout>
